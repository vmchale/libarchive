...
foreign import ccall archive_entry_gid :: Ptr ArchiveEntry -> IO LaInt64
...
foreign import ccall archive_entry_ino :: Ptr ArchiveEntry -> IO LaInt64
foreign import ccall archive_entry_ino64 :: Ptr ArchiveEntry -> IO LaInt64
...
foreign import ccall archive_entry_size :: Ptr ArchiveEntry -> IO LaInt64
...
foreign import ccall archive_entry_uid :: Ptr ArchiveEntry -> IO LaInt64
...
foreign import ccall archive_entry_set_gid :: Ptr ArchiveEntry -> LaInt64 -> IO ()
...
foreign import ccall archive_entry_set_ino :: Ptr ArchiveEntry -> LaInt64 -> IO ()
foreign import ccall archive_entry_set_ino64 :: Ptr ArchiveEntry -> LaInt64 -> IO ()
...
foreign import ccall archive_entry_set_size :: Ptr ArchiveEntry -> LaInt64 -> IO ()
...
foreign import ccall archive_entry_set_uid :: Ptr ArchiveEntry -> LaInt64 -> IO ()
...
foreign import ccall archive_entry_sparse_add_entry :: Ptr ArchiveEntry -> LaInt64 -> LaInt64 -> IO ()
...
foreign import ccall archive_entry_sparse_next :: Ptr ArchiveEntry -> Ptr LaInt64 -> Ptr LaInt64 -> IO CInt
